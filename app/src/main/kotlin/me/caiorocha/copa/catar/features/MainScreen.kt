...
import me.caiorocha.copa.catar.domain.extensions.getDate
import me.caiorocha.copa.catar.domain.model.MatchDomain
import me.caiorocha.copa.catar.domain.model.TeamDomain
import me.caiorocha.copa.catar.ui.theme.Shapes
import me.caiorocha.copa.catar.R
...
fun MainScreen(matches: List<MatchDomain>, onNotificationClick: NotificationOnClick) {
    Column {
        TopAppBar(
            title = { Text(
                        text = "Jogos do Brasil no Catar 2022")},
